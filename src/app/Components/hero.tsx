    ...
    <> 
       <section className="container flex justify-evenly mt-4">
        <div className="content h-fit w-1/2">
          ...
          <h3 className='text-lg leading-10 pt-7 pl-3'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Corruptes hic eos, enim expit quas, commodi fugit reprehenderit obcaecati animi assumenda? Magni.
          </h3>
        </div>
